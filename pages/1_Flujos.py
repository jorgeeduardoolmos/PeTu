...
st.markdown("""
<div style="background:linear-gradient(160deg,#0f1b2d 0%,#152540 100%);padding:0 6vw 60px;text-align:center;">
  <a href="https://atlanta-futsal.streamlit.app/1_Flujos" target="_self" style="display:inline-block;background:#ffd94d;color:#0f1b2d;font-family:sans-serif;font-size:15px;font-weight:700;padding:14px 40px;border-radius:14px;text-decoration:none;">📱 Ver flujos y pantallas de la app</a>
</div>
""", unsafe_allow_html=True)
