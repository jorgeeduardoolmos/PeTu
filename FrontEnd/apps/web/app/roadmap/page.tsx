  ...
  return (
    <div>
      <PageHeader
        label="Documentación"
        title="Roadmap"
        subtitle="3 fases de desarrollo priorizadas por impacto real. Primero lo que duele hoy, después lo que genera retención, finalmente lo que escala el negocio."
      />
        ...
        {roadmap.map((fase) => (
          <div key={fase.numero}>
            ...
            <div
              ...
              style={{ borderColor: `${fase.color}44`, background: `${fase.color}08` }}
            >
              <div className="flex items-center gap-4 flex-wrap">
                <span
                  className="font-black text-5xl opacity-20"
                  style={{ color: fase.color, fontFamily: "Impact, sans-serif" }}
                >
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className="text-xs font-bold tracking-widest uppercase px-3 py-0.5 rounded-full border"
                      style={{ color: fase.color, borderColor: `${fase.color}44`, background: `${fase.color}15` }}
                    >
                      {fase.periodo}
                    </span>
                  </div>
                ...
                return (
                  <div key={f.id} className="bg-[#1a2744] border border-white/10 rounded-xl p-4">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {f.rol.map(r => (
                        <span key={r} className="text-xs bg-white/5 border border-white/10 px-2 py-0.5 rounded-full text-white/40">
                          {r}
                        </span>
                      ))}
                    </div>
