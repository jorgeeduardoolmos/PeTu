...
export const reglas: Regla[] = [
  ...
  // FIXTURE
  { id: "RN-14", categoria: "Fixture", titulo: "Quién carga el fixture", descripcion: "El coordinador o el delegado de cada categoría cargan las fechas. AFA: 10 días antes. Liga: 7 días antes." },
  ...
  { id: "RN-16", categoria: "Fixture", titulo: "Quién carga el resultado", descripcion: "Delegado, ayudante o entrenador pueden cargar el resultado. Editable hasta 24hs después de la carga." },
  { id: "RN-17", categoria: "Fixture", titulo: "Visibilidad del resultado", descripcion: "Visible para todos los roles incluyendo familias." },
  // JUGADORES
  { id: "RN-18", categoria: "Jugadores", titulo: "Datos básicos vs valoración interna", descripcion: "Datos básicos visibles para coordinador y entrenadores de la categoría. Valoración interna solo para coordinador y el entrenador de esa categoría." },
